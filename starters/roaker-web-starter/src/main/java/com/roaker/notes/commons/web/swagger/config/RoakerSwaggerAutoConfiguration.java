package com.roaker.notes.commons.web.swagger.config;
...
// 设置为 false 时，禁用
public class RoakerSwaggerAutoConfiguration {
    ...
    private static final String HEADER_TENANT_ID = "roaker-tenant";
}
