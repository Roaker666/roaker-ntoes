package com.roaker.notes.quartz.core.scheduler;

import com.roaker.notes.quartz.core.enums.JobDataKeyEnum;
import com.roaker.notes.quartz.core.handler.JobHandlerInvoker;
import org.quartz.*;

import static com.roaker.notes.exception.enums.GlobalErrorCodeConstants.NOT_IMPLEMENTED;
...
public class SchedulerManager {
    ...
    public void addJob(Long jobId, String jobHandlerName, String jobHandlerParam, String cronExpression,
        ...
        JobDetail jobDetail = JobBuilder.newJob(JobHandlerInvoker.class)
                .usingJobData(JobDataKeyEnum.JOB_ID.getName(), jobId)
                .usingJobData(JobDataKeyEnum.JOB_HANDLER_NAME.getName(), jobHandlerName)
