...
public class WxWapPayClient extends AbstractWxPayClient{
    public WxWapPayClient(Long channelId, WxPayClientConfig config) {
        super(channelId, PayChannelEnum.WX_WAP.getChannelCode(), config);
    }
    ...
    protected PayOrderRespDTO doUnifiedOrderV2(PayOrderUnifiedReqDTO reqDTO) throws WxPayException {
        ...
        // 转换结果
        return PayOrderRespDTO.waitingOf(PayOrderDisplayModeEnum.URL.getName(), response.getMwebUrl(),
    ...
    protected PayOrderRespDTO doUnifiedOrderV3(PayOrderUnifiedReqDTO reqDTO) throws WxPayException {
        ...
        // 转换结果
        return PayOrderRespDTO.waitingOf(PayOrderDisplayModeEnum.URL.getName(), response,
                reqDTO.getOutTradeNo(), response);
    }
