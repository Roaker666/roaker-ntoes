package com.roaker.notes.datapermission.core.db;
        ...
        public void addNoRewritable(MappedStatement ms, List<DataPermissionRule> rules) {
            for (DataPermissionRule rule : rules) {
                ...
                if (CollUtil.isNotEmpty(mappedStatementIds)) {
                    ...
                    noRewritableMappedStatements.put(rule.getClass(), org.mapstruct.ap.internal.util.Collections.asSet(ms.getId()));
                }
            }
        }
