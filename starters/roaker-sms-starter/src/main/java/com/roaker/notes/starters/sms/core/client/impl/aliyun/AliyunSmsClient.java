...
public class AliyunSmsClient extends AbstractSmsClient {
    ...
    protected void doInit() {
        DefaultProfile profile = DefaultProfile.getProfile(ENDPOINT, properties.getApiKey(), properties.getApiSecret());
    ...
    protected List<SmsReceiveRespDTO> doParseSmsReceiveStatus(String text) throws Throwable {
        List<SmsReceiveStatus> statuses = JacksonUtils.fromList(text, SmsReceiveStatus.class);
