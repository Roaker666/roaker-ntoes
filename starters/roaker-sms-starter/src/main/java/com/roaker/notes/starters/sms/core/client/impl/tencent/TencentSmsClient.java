...
public class TencentSmsClient extends AbstractSmsClient {
    ...
    private SendSmsRequest buildSendSmsRequest(Long sendLogId,
        ...
        request.setTemplateParamSet(RoakerArrayUtils.toArray(templateParams, e -> String.valueOf(e.getValue())));
        request.setSessionContext(JacksonUtils.toJSON(new SessionContext().setLogId(sendLogId)));
        return request;
    }

    @Override
    protected List<SmsReceiveRespDTO> doParseSmsReceiveStatus(String text) throws Throwable {
        List<SmsReceiveStatus> callback = JacksonUtils.fromList(text, SmsReceiveStatus.class);
        return RoakerCollectionUtils.convertList(callback, status -> {
