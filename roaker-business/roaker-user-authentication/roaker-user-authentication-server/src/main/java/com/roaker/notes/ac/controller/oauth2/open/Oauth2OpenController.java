package com.roaker.notes.ac.controller.oauth2.open;
...
import com.roaker.notes.ac.controller.oauth2.open.vo.open.Oauth2OpenAccessTokenRespVO;
import com.roaker.notes.ac.controller.oauth2.open.vo.open.Oauth2OpenAuthorizeInfoRespVO;
import com.roaker.notes.ac.controller.oauth2.open.vo.open.Oauth2OpenCheckTokenRespVO;
import com.roaker.notes.ac.converter.oauth2.Oauth2OpenConvert;
import com.roaker.notes.ac.dal.dataobject.oauth2.Oauth2AccessTokenDO;
import com.roaker.notes.ac.dal.dataobject.oauth2.Oauth2ApproveDO;
...
import com.roaker.notes.ac.service.oauth2.Oauth2GrantService;
import com.roaker.notes.ac.service.oauth2.Oauth2TokenService;
import com.roaker.notes.ac.utils.Oauth2Utils;
 ...
 * @since 1.0
 */
@Tag(name = "开放平台 - Oauth2.0 授权")
@RestController
@RequestMapping("/auth/open-api/oauth2")
@Validated
@Slf4j
...
public class Oauth2OpenController {
    ...
    public CommonResult<String> approveOrDeny(@RequestParam("response_type") String responseType,
                                              ...
                                              @RequestParam(value = "state", required = false) String state) {
        Map<String, Boolean> scopes = JacksonUtils.from(scope, Map.class);
    ...
    private String getImplicitGrantRedirect(Long userId, Oauth2ClientDO client,
        ...
        return Oauth2Utils.buildImplicitRedirectUri(redirectUri, accessTokenDO.getAccessToken(), state, accessTokenDO.getExpiresTime(),
                scopes, JacksonUtils.from(client.getAdditionalInformation(), Map.class));
    }
