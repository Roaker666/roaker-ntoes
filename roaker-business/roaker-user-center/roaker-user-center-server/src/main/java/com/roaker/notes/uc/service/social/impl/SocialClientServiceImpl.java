package com.roaker.notes.uc.service.social.impl;
...
import com.roaker.notes.uc.dal.dataobject.social.SocialClientDO;
import com.roaker.notes.uc.dal.mapper.social.SocialClientMapper;
import com.roaker.notes.uc.service.social.SocialClientService;
import com.roaker.notes.uc.vo.social.client.SocialClientPageReqVO;
import com.roaker.notes.uc.vo.social.client.SocialClientSaveReqVO;
...
public class SocialClientServiceImpl implements SocialClientService {
    ...
    AuthRequest buildAuthRequest(Integer socialType, Integer userType) {
        ...
        AuthRequest request = authRequestFactory.get(SocialTypeEnum.valueOfType(socialType).getName());
        ...
        if (client != null && Objects.equals(client.getStatus(), CommonStatusEnum.ENABLE)) {
    ...
    WxMpService getWxMpService(Integer userType) {
        ...
        SocialClientDO client = socialClientMapper.selectBySocialTypeAndUserType(
                SocialTypeEnum.WECHAT_MP.getCode(), userType);
        if (client != null && Objects.equals(client.getStatus(), CommonStatusEnum.ENABLE)) {
    ...
    WxMaService getWxMaService(Integer userType) {
        ...
        SocialClientDO client = socialClientMapper.selectBySocialTypeAndUserType(
                SocialTypeEnum.WECHAT_MINI_APP.getCode(), userType);
        if (client != null && Objects.equals(client.getStatus(), CommonStatusEnum.ENABLE)) {
