package com.roaker.notes.uc.vo.logger.operatelog;
...
public class OperateLogRespVO {
    ...
    @DictFormat(OperateTypeEnum.class)
    private String type;

    @Schema(description = "操作明细", example = "修改编号为 1 的用户信息，将性别从男改成女，将姓名从Roaker改成源码。")
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "cn.iocoder.Roaker.adminserver.UserController.save(...)")
