...
import com.roaker.notes.uc.dal.mapper.codegen.CodegenColumnMapper;
import com.roaker.notes.uc.dal.mapper.codegen.CodegenTableMapper;
...
import com.roaker.notes.uc.service.codegen.CodegenService;
import com.roaker.notes.uc.service.db.DatabaseTableService;
import com.roaker.notes.uc.vo.codegen.CodegenCreateListReqVO;
import com.roaker.notes.uc.vo.codegen.CodegenUpdateReqVO;
import com.roaker.notes.uc.vo.codegen.table.CodegenTablePageReqVO;
...
public class CodegenServiceImpl implements CodegenService {
    ...
    private Long createCodegen(String userId, Long dataSourceConfigId, String tableName) {
        // 从数据库中，获得数据库表结构
    ...
    private Long createCodegen0(String userId, Long dataSourceConfigId, TableInfo tableInfo) {
        ...
        table.setFrontType(CommonEnum.of(codegenProperties.getFrontType(), CodegenFrontTypeEnum.class));
    ...
    public void updateCodegen(CodegenUpdateReqVO updateReqVO) {
        ...
        // 校验主表字段存在
        if (Objects.equals(updateReqVO.getTable().getTemplateType(), CodegenTemplateTypeEnum.SUB.getCode())) {
    ...
    public Map<String, String> generationCodes(Long tableId) {
        ...
        if (CodegenTemplateTypeEnum.isMaster(table.getTemplateType().getCode())) {
            // 校验子表存在
            subTables = codegenTableMapper.selectListByTemplateTypeAndMasterTableId(
                    CodegenTemplateTypeEnum.SUB.getCode(), tableId);
