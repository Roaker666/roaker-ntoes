package com.roaker.notes.uc.vo.social.client;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "Roaker商城")
    ...
    public boolean isAgentIdValid() {
        ...
        return !Objects.equals(socialType, SocialTypeEnum.WECHAT_ENTERPRISE.getCode())
