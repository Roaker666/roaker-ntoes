...
public interface PayWalletService {
     ...
     * @param userType 用户类型
     */
    PayWalletDO getOrCreateWallet(String userId, Integer userType);
     ...
     * @param price      金额
     */
    PayWalletTransactionDO orderPay(String userId, Integer userType, String outTradeNo, Integer price);
