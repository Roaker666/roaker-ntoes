package com.roaker.notes.notify.consumer;
...
@Component
@Slf4j
@RocketMQMessageListener(nameServer = "${rocket.name-server}", topic = "${" + NotifyCommonConstants.SMS_TOPIC + "}", consumerGroup = "${" + KEY_CONSUMER_GROUP + "}")
