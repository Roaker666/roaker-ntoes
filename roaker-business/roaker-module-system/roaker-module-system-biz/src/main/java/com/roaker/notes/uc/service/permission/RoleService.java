...
public interface RoleService {
     ...
     * @return 角色编号
     */
    Long createRole(@Valid RoleCreateReqVO createReqVO, Integer type);
     ...
     * @return 角色
     */
    RoleInfoDO getRoleFromCache(Long id);
     ...
     * @return 角色列表
     */
    List<RoleInfoDO> getRoleList(Collection<Long> ids);
     ...
     * @return 角色数组
     */
    List<RoleInfoDO> getRoleListFromCache(Collection<Long> ids);
     ...
     * @return 角色列表
     */
    List<RoleInfoDO> getRoleListByStatus(Collection<Integer> statuses);
