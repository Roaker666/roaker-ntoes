package com.roaker.notes.uc.controller.codegen;
...
public class CodegenController{
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "Roaker"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "Roaker")
    })
