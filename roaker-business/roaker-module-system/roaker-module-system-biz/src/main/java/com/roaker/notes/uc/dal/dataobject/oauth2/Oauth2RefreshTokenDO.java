 ...
 * @since 1.0
 */
@TableName(value = "sys_oauth2_refresh_token_tab", autoResultMap = true)
@KeySequence("sys_oauth2_access_token_tab_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
